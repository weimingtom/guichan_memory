...
static void BlitBto1(SDLMOD_BlitInfo *info)
{
	int c;
	int width, height;
	uint8_t *src, *map, *dst;
...
static void BlitBto2(SDLMOD_BlitInfo *info)
{
	int c;
	int width, height;
	uint8_t *src;
...
static void BlitBto3(SDLMOD_BlitInfo *info)
{
	int c, o;
	int width, height;
	uint8_t *src, *map, *dst;
...
static void BlitBto4(SDLMOD_BlitInfo *info)
{
	int width, height;
	uint8_t *src;
	uint32_t *map, *dst;
...
static void BlitBto1Key(SDLMOD_BlitInfo *info)
{
...
static void BlitBto2Key(SDLMOD_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void BlitBto3Key(SDLMOD_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void BlitBto4Key(SDLMOD_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void BlitBtoNAlpha(SDLMOD_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void BlitBtoNAlphaKey(SDLMOD_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
	...
	SDLMOD_PixelFormat *dstfmt = info->dst;
	const SDLMOD_Color *srcpal	= srcfmt->palette->colors;
	int dstbpp;
	int c;
...
static SDLMOD_loblit bitmap_blit[] = {
	NULL, BlitBto1, BlitBto2, BlitBto3, BlitBto4
};

static SDLMOD_loblit colorkey_blit[] = {
    NULL, BlitBto1Key, BlitBto2Key, BlitBto3Key, BlitBto4Key
};

SDLMOD_loblit SDLMOD_CalculateBlit0(SDLMOD_Surface *surface, int blit_index)
{
	int which;
