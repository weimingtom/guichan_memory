...
/*#define GetBlitFeatures() ((uint32_t)(SDLMOD_HasMMX() ? 1 : 0))*/
...
static void Blit_RGB888_index8(SDLMOD_BlitInfo *info)
{
...
static void Blit_RGB888_RGB555(SDLMOD_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit_RGB888_RGB565(SDLMOD_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit_RGB565_32(SDLMOD_BlitInfo *info, const uint32_t *map)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit_RGB565_ARGB8888(SDLMOD_BlitInfo *info)
{
...
static void Blit_RGB565_ABGR8888(SDLMOD_BlitInfo *info)
{
...
static void Blit_RGB565_RGBA8888(SDLMOD_BlitInfo *info)
{
...
static void Blit_RGB565_BGRA8888(SDLMOD_BlitInfo *info)
{
...
#endif
static void Blit_RGB888_index8_map(SDLMOD_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void BlitNto1(SDLMOD_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit4to4MaskAlpha(SDLMOD_BlitInfo *info)
{
...
static void BlitNtoN(SDLMOD_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
...
static void BlitNtoNCopyAlpha(SDLMOD_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void BlitNto1Key(SDLMOD_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void Blit2to2Key(SDLMOD_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
...
static void BlitNtoNKey(SDLMOD_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
static void BlitNtoNKeyCopyAlpha(SDLMOD_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	uint8_t *src = info->s_pixels;
...
SDLMOD_loblit SDLMOD_CalculateBlitN(SDLMOD_Surface *surface, int blit_index)
{
	...
	if ( blit_index & 2 ) {
	        ...
	        return SDLMOD_CalculateAlphaBlit(surface, blit_index);
	}
